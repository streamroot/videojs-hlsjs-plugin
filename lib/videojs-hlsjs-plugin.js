...
var registerSourceHandler = function (videojs) {
    ...
    function Html5Hlsjs(source, tech) {
        ...
        function _initHlsjs() {
            var hlsjsPluginConfigRef = _player.srOptions_ && _player.srOptions_.hlsjsPluginConfig || tech.options_.hlsjsPluginConfig;
            var hlsjsPluginConfig = Object.assign(
                { enable: true },
                hlsjsPluginConfigRef ? _oneLevelObjClone(hlsjsPluginConfigRef) : {}
            );
            if (!hlsjsPluginConfig.enable) return;
