...
var registerSourceHandler = function (videojs) {
    ...
    function Html5Hlsjs(source, tech) {
        ...
        function _levelLabel(level) {
            if (typeof _customLevelLabel !== 'undefined') return _customLevelLabel(level);
...
function streamrootHlsjsConfigHandler(options) {
    ...
    if (options.levelLabelHandler) {
        _customLevelLabel = options.levelLabelHandler;
    }
}
